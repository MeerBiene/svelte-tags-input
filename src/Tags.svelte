<script>
  ...
  export let inputTagClass = null;
  export let inputTagRemoveClass = null;
...
>
  {#if tags.length > 0}
    {#each tags as tag, i}
      <span class={inputTagClass ? inputTagClass : "svelte-tags-input-tag"}>
